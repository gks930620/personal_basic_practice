...
public class OrderApiController {
    ...
    // 데이터를 전부 가져와 담을 수 있는 OrderFlatDto를 만들었는데
    //APi 스펙 상 OrderQueryDto를 반환해야한다면
    // stream 돌려서 OrderQuery Dto로 바꾸기
    ...
    @Data  // DTO는 Entity에 의존하면 안됨.  관련된 엔티티들 모두 DTO로 변경해서 사용해야 함
