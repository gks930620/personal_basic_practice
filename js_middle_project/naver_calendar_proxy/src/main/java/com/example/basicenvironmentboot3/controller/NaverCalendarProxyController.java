package com.example.basicenvironmentboot3.controller;
...
public class NaverCalendarProxyController {

    @ResponseBody
    @RequestMapping(value = "/createSchedule" )
    public String createSchedule(String token){
        String header = "Bearer " + token; // Bearer 다음에 공백 추가 token이 나니까...
        try {
